    ...
    <div>
      ...
      <div className="projects-cointainer">
        <div className="project-cointainer">
          <a href="https://cassieellaelaine.github.io/Netflix-and-Chill-Generator" target="_blank"><img className="project-img" src={image1} alt="Website preview for tv show finder"></img></a>
          ...
          <a href="https://github.com/Cassieellaelaine/Netflix-and-Chill-Generator" target="_blank"><img className="github-logo" src={github} alt="Github logo to visit Github repo for this project"></img></a>
        </div>
        <div className="project-cointainer">
          <a href="https://pacific-wildwood-17680-8e953e055e35.herokuapp.com" target="_blank"><img className="project-img" src={image2} alt="Website preview for tv show finder"></img></a>
          ...
          <a href="https://github.com/Anthonycodinach/Volunteer-Event-Tracker" target="_blank"><img className="github-logo" src={github} alt="Github logo to visit Github repo for this project"></img></a>
        </div>
        <div className="project-cointainer">
          <a href="https://lifetimes-trip-planner-e4ba065bd3bc.herokuapp.com/" target="_blank"><img className="project-img" src={image3} alt="Website preview for tv show finder"></img> </a>
          <h2 className="project3-title"> Lifetimes </h2>
          ...
          <a href="https://github.com/Anthonycodinach/Vacation-Itinerary-Planner" target="_blank"><img className="github-logo" src={github} alt="Github logo to visit Github repo for this project"></img></a>
        </div>
      </div>
